...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='WaveNet-B/Other_Nets/Ainputa', type=str) #gt
    parser.add_argument('-dirB', default='WaveNet-B/Other_Nets/L_CDAN/L_CDAN/Epoch200', type=str) #enhanced

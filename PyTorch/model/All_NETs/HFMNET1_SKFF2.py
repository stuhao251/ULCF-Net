...
class HFMNET(nn.Module):
    def __init__(self,in_chn=3, wf=96):
        ...
        self.hfb5 = HFB(n_feat=768, o_feat=384, kernel_size=3, bias=False, act=nn.LeakyReLU())
        self.up3 = PS_up(384, 192, 2)

        self.hfb6 = HFB(n_feat=384, o_feat=192, kernel_size=3, bias=False, act=nn.LeakyReLU())
        self.up2 = PS_up(192, 96, 2)

        self.hfb7 = HFB(n_feat=192, o_feat=96, kernel_size=3, bias=False, act=nn.LeakyReLU())
        #输入分支
...
if __name__=='__main__':
    ...
    print('parameters:', params / 1e6)  #11M

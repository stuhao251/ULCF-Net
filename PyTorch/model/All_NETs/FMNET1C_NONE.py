...
class HFMNET(nn.Module):
    def __init__(self,in_chn=3, wf=96):
        ...
        self.hfb5 = FB(n_feat=960, o_feat=384, kernel_size=3, bias=False, act=nn.LeakyReLU())
        self.up3 = PS_up(384, 192, 2)

        self.hfb6 = FB(n_feat=576, o_feat=192, kernel_size=3, bias=False, act=nn.LeakyReLU())
        self.up2 = PS_up(192, 96, 2)

        self.hfb7 = FB(n_feat=288, o_feat=96, kernel_size=3, bias=False, act=nn.LeakyReLU())
        #输入分支
...
if __name__=='__main__':
    ...
    print('parameters:', params / 1e6)  #15M
    print('flops', flops / 1e9)         #193

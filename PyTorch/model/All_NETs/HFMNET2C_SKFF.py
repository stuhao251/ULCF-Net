...
class HFMNET(nn.Module):
    def __init__(self,in_chn=3, wf=96):
        ...
        #底部
        self.hfb5 = HFB(n_feat=864, o_feat=1536, kernel_size=3, bias=False, act=nn.LeakyReLU())
        #解码
        self.up4 = PS_up(1536, 768, 2)
        self.hfb6 = HFB(n_feat=1920, o_feat=768, kernel_size=3, bias=False, act=nn.LeakyReLU())

        self.up3 = PS_up(768,384,2)
        self.hfb7 = HFB(n_feat=960, o_feat=384, kernel_size=3, bias=False, act=nn.LeakyReLU())

        self.up2 = PS_up(384, 192, 2)
        self.hfb8 = HFB(n_feat=576, o_feat=192, kernel_size=3, bias=False, act=nn.LeakyReLU())

        self.up1 = PS_up(192, 96, 2)
        self.hfb9 = HFB(n_feat=288, o_feat=96, kernel_size=3, bias=False, act=nn.LeakyReLU())
        #输入分支
...
if __name__=='__main__':
    ...
    print('parameters:', params / 1e6)  #47
    print('flops', flops / 1e9)         #221
